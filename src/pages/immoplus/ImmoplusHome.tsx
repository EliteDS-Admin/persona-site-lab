...
const statements = [
  {
    key: "slogan",
    title: "Slogan",
    text: "Devenez propriétaire grâce à Immo-Plus (le boulanger de l'immobilier)",
  },
  {
    key: "message",
    title: "Message",
  ...
  },
  {
    key: "volonte",
    title: "Volonté",
    text: "Immo-Plus s'engage à vous fournir un maximum d'accompagnement, de l'obtention de votre titre foncier à la remise des clés. Nous vous apprenons à mieux gérer votre bien immobilier.",
  },
];
          ...
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 py-16 sm:py-20 lg:flex-row lg:items-center lg:py-24">
            <div className="space-y-6 lg:max-w-xl">
              ...
              <p className="text-base text-white/90">
                De la première visite jusqu'à la remise des clés, Immo-Plus vous guide sur des terrains titrés et des constructions modulaires pensées pour durer.
              </p>
